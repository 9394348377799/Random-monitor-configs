HOW TO USE:
- You must have the "NIRCMD" tool installed. you can find it here: https://www.nirsoft.net/utils/nircmd.html.

- After downloading, you must go into the "enabler.bat" and change the SET_PATH in "toggle_monitor.ps1" to wherever you download this project.
